...
- [FastAPI Casbin Auth](https://github.com/officialpycasbin/fastapi-casbin-auth) - Supports various access control models like ACL, RBAC, and ABAC through Casbin.
